...
/**
 * Custom ORM container class, for Story Data. <p> This class is meant as a helper class for those working with the ContentProvider. The use of this class is completely optional. <p> ORM = Object Relational Mapping http://en.wikipedia.org/wiki/Object-relational_mapping <p> This class is a simple one-off POJO class with some simple ORM additions that allow for conversion between the incompatible types of the POJO java classes, the 'ContentValues', and the 'Cursor' classes from the use with ContentProviders.
